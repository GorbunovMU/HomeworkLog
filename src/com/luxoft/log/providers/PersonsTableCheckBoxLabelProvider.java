...
public class PersonsTableCheckBoxLabelProvider extends ColumnLabelProvider {
	private static final String CHECKED_KEY = "CHECKED";
	private static final String UNCHECK_KEY = "UNCHECKED";
	
	public PersonsTableCheckBoxLabelProvider(ColumnViewer viewer) {
	...
	protected boolean isChecked(Object element) {
		return ((Person) element).isTaskDone();
	}
}
